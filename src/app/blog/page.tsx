...
const POPULARITY_ORDER: Record<string, number> = {
  "my attempt to solve debate will not work": 1,
  "are llm emotions persistent like human emotions?": 2,
  "anthropic is not your friend": 3,
  "slutcon is the best place on earth to practice the arts of sleeping with women": 4,
  "are you an idiot or an asshole?": 5,
  "how to forecast the chance that a potential partner will cancel you": 6,
  "why i'm teaching tiktokers about existential risk": 7,
  "brangus's 10 rules for sleeping with women": 8,
  "i had sex with my brother's wife when i was thirteen": 9,
  "how to vape on planes without getting caught": 10,
  "i stopped going to school in fifth grade and i don't regret it": 11,
  "predeployment interview excerpt — jan 12, 2029": 12,
  "is buying dinner for women defecting against other men?": 13,
  "ask \"why do you believe that?\" not \"do you have any evidence?\"": 14,
  "brangus's advice for making the most out of inkhaven 2": 15,
  ...
  "an apology on behalf of fools for the detail oriented": 19,
};
