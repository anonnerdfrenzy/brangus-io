...
const POPULARITY_ORDER: Record<string, number> = {
  ...
  "slutcon is the best place on earth to practice the arts of sleeping with women": 6,
  "is buying dinner for women defecting against other men?": 7,
  "why i'm teaching tiktokers about existential risk": 8,
  "are you an idiot or an asshole?": 9,
  "how to forecast the chance that a potential partner will cancel you": 10,
  "ask \"why do you believe that?\" not \"do you have any evidence?\"": 11,
  "my attempt to solve debate will not work": 12,
  "anthropic is not your friend": 13,
  "brangus's advice for making the most out of inkhaven 2": 14,
  "an apology on behalf of fools for the detail oriented": 15,
  "i regret to inform you that exist takes two inputs": 16,
  "you would probably punish hitler even if nobody would find out if you didn't": 17,
  "\"burden of proof\" is a weird concept": 18,
  "insight into injunction-like cognitive tech often undermines the tech, but you should use it anyway": 19,
  "are llm emotions persistent like human emotions?": 20,
};

const LIKES: Record<string, number> = {
  "brangus's 10 rules for sleeping with women": 577,
  "i had sex with my brother's wife when i was thirteen": 341,
  "how to vape on planes without getting caught": 135,
  "i stopped going to school in fifth grade and i don't regret it": 55,
  "predeployment interview excerpt — jan 12, 2029": 48,
  "slutcon is the best place on earth to practice the arts of sleeping with women": 29,
  "is buying dinner for women defecting against other men?": 29,
  "why i'm teaching tiktokers about existential risk": 28,
  "are you an idiot or an asshole?": 25,
  "how to forecast the chance that a potential partner will cancel you": 25,
  "ask \"why do you believe that?\" not \"do you have any evidence?\"": 24,
  "my attempt to solve debate will not work": 22,
  "anthropic is not your friend": 21,
  "brangus's advice for making the most out of inkhaven 2": 19,
  "an apology on behalf of fools for the detail oriented": 16,
  "i regret to inform you that exist takes two inputs": 15,
  ...
  "are llm emotions persistent like human emotions?": 5,
};
